...
public class ComboboxAuthorsComponent extends JPanel{
    ...
    public ComboboxAuthorsComponent(int heightPanel, String text, int comboboxWidth) {
        initComponents(heightPanel, text, comboboxWidth);
    }
    
    private void initComponents(int heightPanel, String text, int comboboxWidth){
